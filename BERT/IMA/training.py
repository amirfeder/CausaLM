...
def main():
    ...
    train_all_models(args.treatment, args.domain, args.group, args.masking_method, args.pretrained_epoch)
...
def train_models(hparams: Dict, group: str, pretrained_epoch: int):
    ...
    ima_model = train_models_unit(hparams, "IMA", group)
    pos_tagging_model = train_models_unit(hparams, "POS_Tagging", group)
    if hparams["bert_params"]["bert_state_dict"]:
...
@timer
def train_all_models(treatment: str, domain: str, group: str, masking_method: str, pretrained_epoch: int):
    ...
    train_models(hparams, group, pretrained_epoch)
