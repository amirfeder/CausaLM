...
SENTIMENT_MLM_DIR = f"{SENTIMENT_MODELS_DIR}/MLM"
SENTIMENT_MLM_PRETRAIN_DIR = f"{SENTIMENT_MLM_DIR}/Pretrain"

SENTIMENT_ADJECTIVES_DATASETS_DIR = f"{CAUSALM_DIR}/Sentiment_Adjectives/datasets"
SENTIMENT_ADJECTIVES_IMA_DIR = f"{SENTIMENT_MODELS_DIR}/IMA"
SENTIMENT_ADJECTIVES_IMA_PRETRAIN_DIR = f"{SENTIMENT_ADJECTIVES_IMA_DIR}/Pretrain"
